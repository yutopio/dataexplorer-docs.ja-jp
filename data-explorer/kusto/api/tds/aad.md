...
Kusto にプロビジョニングされた Azure AD アプリケーションは、Kusto に接続するための Azure AD をサポートする SQL クライアントライブラリを使用できます。 Azure AD アプリケーションの詳細については、「 [Azure AD アプリケーションの作成](../../../provision-azure-ad-app.md)」を参照してください。
