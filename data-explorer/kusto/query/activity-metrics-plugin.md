...
:::image type="content" source="images/activity-metrics-plugin/activity-metrics-churn-and-retention.png" border="false" alt-text="アクティビティー・メトリックのチャーンと保持":::
...
:::image type="content" source="images/activity-metrics-plugin/activity-metrics-dcount-and-dcount-newvalues.png" border="false" alt-text="アクティビティー・メトリックの dcount および dcount 新しい値":::
