...
:::image type="content" source="images/geo-distance-point-to-line-function/us-south-coast-storm-events.png" alt-text="北ラスベガス空港と道路間の距離":::
...
NY タクシーは、ups を集荷します。 ピックアップは、定義されている複数行から最大0.1 メートルの距離でフィルター処理されます。

:::image type="content" source="images/geo-distance-point-to-line-function/madison-ave-road.png" alt-text="北ラスベガス空港と道路間の距離":::
